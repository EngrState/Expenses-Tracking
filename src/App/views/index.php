...
<section class="container mx-auto mt-12 p-4 bg-white shadow-md border border-gray-200 rounded">
  ...
  <form method="GET" class="mt-4 w-full">
    <div class="flex">
      <input name="s"
        value="<?php echo e((string) $searchTerm ?? ''); ?>" type="text" class="w-full rounded-l-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" placeholder="Enter search term" />
          ...
          <td class="p-4 text-sm text-gray-600">
            <?php foreach ($transaction['receipts'] as $receipts): ?>
              <div class="inline-block relative cursor-pointer">
                <a 
                href="/transaction/<?php echo e($transaction['id']); ?>/receipt/<?php echo e($receipts['id']); ?>">
                ...
                <form action="/transaction/<?php echo e($transaction['id']); ?>/receipt/<?php echo e($receipts['id']); ?>" method="POST">
